...
agent skills for byteowlz tools and beyond.
...
- [`dpty-operate`](skills/dpty-operate/SKILL.md) - Operate a dpty machine unit — introspect capability, match and run recipes, place and supervise Work Requests/Instances, handle unload policy, and report to gvnr over the mesh.
...
just copy to your local agent skills directory (~/.codex/skills, ~/.claude/skills/, ~/.pi/agent/skills/ or ~/.agents/skills/ etc)

or install via npm (let's you pick what you want to install):

```bash
npx skills@latest add byteowlz/skillissues
